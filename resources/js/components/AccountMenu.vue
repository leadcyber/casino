<template>
  <v-menu v-model="menu" offset-y left>
    ...
    <v-list>
      ...
      <v-list-item :to="{ name: 'user.account.transactions' }" link exact @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-icon>
      ...
      <v-list-item v-if="paymentsPackageIsEnabled" :to="{ name: 'user.account.deposits.index' }" link exact @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-icon>
      ...
      <v-list-item v-if="paymentsPackageIsEnabled" :to="{ name: 'user.account.withdrawals.index' }" link exact @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-icon>
      ...
      <v-list-item v-if="faucetEnabled" :to="{ name: 'user.account.faucet' }" link exact @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-icon>
