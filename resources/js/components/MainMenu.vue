<template>
  <v-list dense>
    <v-list-item :to="{ name: 'home' }" link exact @click="MenuNavigationStatus(!isMobile)">
      <v-list-item-action>
    ...
    <template v-if="authenticated">
      ...
      >
        ...
        <template v-for="(game, i) in originalGames">
          <v-list-item :key="i" :to="game.route" link exact @click="MenuNavigationStatus(!isMobile)">
            <v-list-item-content>
              <v-list-item-title>
                {{ game.name }}
              </v-list-item-title>
      ...
      <template v-if="gameProvidersPackageIsEnabled">
        ...
        >
          ...
          <template v-for="(game, k) in category.games">
            <v-list-item :key="k" :to="game.route" link exact @click="MenuNavigationStatus(!isMobile)">
              <v-list-item-content>
                <v-list-item-title>
                  {{ game.name }}
                </v-list-item-title>
      ...
      >
        ...
        <template v-for="(pkg, id) in predictions">
          <v-list-item :key="id" :to="{ name: 'prediction', params: { packageId: id }}" link exact @click="MenuNavigationStatus(!isMobile)">
            <v-list-item-content>
      ...
      <v-list-item v-if="rafflePackageIsEnabled" :to="{ name: 'raffles' }" link exact class="main-menu-raffles" @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-action>
      ...
      <v-list-item v-if="paymentsPackageIsEnabled" :to="{ name: 'user.account.deposits.index' }" link exact class="main-menu-deposits" @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-action>
      ...
      <v-list-item v-if="paymentsPackageIsEnabled" :to="{ name: 'user.account.withdrawals.index' }" link exact class="main-menu-withdrawals" @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-action>
      ...
      <v-list-item :to="{ name: 'history' }" link exact class="main-menu-history" @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-action>
      ...
      <v-list-item v-if="leaderboardPageEnabled" :to="{ name: 'leaderboard' }" link exact class="main-menu-leaderboard" @click="MenuNavigationStatus(!isMobile)">
        <v-list-item-action>
